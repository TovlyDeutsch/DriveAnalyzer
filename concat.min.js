...
function fileCount(e){var t=getFilesNotOwned(e),a=t[0],o=t[1];return document.getElementById("file-counts").innerHTML='<p id="file-count" class="mdl-typography--headline">  Files You Own: '+a.length+'</p>  <p id="file-count" class="mdl-typography--headline">  Files Shared With You: '+o.length+'</p>  <p id="file-count" class="mdl-typography--headline">  Total: '+e.length+"</p>",[a,o]}function getFilesNotOwned(e){var t=[],a=e.filter(function(e){return e.ownedByMe===!0||void t.push(e)});return[a,t]}function displayGraph(e){function t(){var e=google.visualization.arrayToDataTable(s),t={title:u,chartArea:{left:100}},n=new google.visualization.PieChart(document.getElementById("piechart"));n.draw(e,t),$("#graph-loader").remove(),$("#piechart-button").on("click",function(){s==a?(s=o,u="Percentage by quota used (bytes)"):(s=a,u="Percentage by number of files");var e=google.visualization.arrayToDataTable(s),t={title:u,chartArea:{left:100}};n.draw(e,t)})}var a=[["Type","Number"]],o=[["Type","Quota Used"]],n=1,r=seperateBy(e,"type");for(var l in r){a.push([l,r[l].files.length]),o.push([l,0]);for(var i in r[l].files)0!=r[l].files[i].quotaBytesUsed&&(o[n][1]+=parseInt(r[l].files[i].quotaBytesUsed));n+=1}var s=o,u="Percentage by quota used (bytes)";google.charts.load("current",{packages:["corechart"]}),google.charts.setOnLoadCallback(t)}